...
//.........
    ...
    if (profile.me.id > 0) {
        toastr.success(lurdinha[0].dialogo, lurdinha[0].missao, {"iconClass": 'missao-info'});
        console.log("user: " + profile.me.id)
    } else {
        console.log("você precisa do facebook para jogar ")
    }
//.....
}
...
function onPlay() {
    ...
    var lurdinha = JSON.parse(localStorage.getItem('gamecomenius.com.lurdinha')) || [];
    if (profile.me.id > 0) {
        toastr.success(lurdinha[1].dialogo, lurdinha[1].missao, {"iconClass": 'missao-info'});
        console.log("user: " + profile.me.id)
    } else {
        console.log("você precisa do facebook para jogar ")
    }
    ...
    if (!hasPermission('user_friends') && !friendCache.reRequests['user_friends']) {
...
function onChallengeSend() {
    ...
    sendChallenge(to, 'Game Comenius is great fun! Come and check it out!', function () {
