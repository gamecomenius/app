var appId = '691143127686945';
var appNamespace = 'gamecomenius';
...
function sendBrag(caption, callback) {
  FB.ui({ method: 'feed',
    caption: caption,
    picture: 'https://escoladocerebro.org/gamecomenius/images/logo_large.jpg',
  ...
  if( !hasPermission('publish_actions') ) {
    ...
    if( !friendCache.reRequests['publish_actions'] ) {
      ...
      FB.ui({
        ...
        action_type: 'gamecomenius:publicou',
        action_properties: {
    ...
    FB.api('/me/gamecomenius:publicou', 'post', {
      profile: params.profile,
      score: params.score,
      coins: params.coins,
