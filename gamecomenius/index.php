...
<html>
  <head>
    ...
    <meta property="og:image" content="https://escoladocerebro.org/gamecomenius/images/logo_large.jpg"/>
  ...
  <body>
    ...
    <section id="gameover" class="hidden">
      ...
      <div class="stats">
        <p>You learn <span class="name">...</span> <span class="score">...</span> times and collected <span class="coins">...</span> <span class="coins_plurality">coins</span>!</p>
      </div>
      <div class="buttons">
        <button class="image challenge"></button>
      </div>
    ...
    <footer>
      <div class="container">
        <p><a href="https://www.facebook.com/appcenter/gamecomenius">View Friend Smash! on App Center</a></p>
      </div>
    </footer>
